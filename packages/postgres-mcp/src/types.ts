...
export const appInput = {
  app: z.string().min(1).describe('App id (UUID) or name the Postgres databases are attached to.'),
};
...
export const maintenanceWindowSetInput = {
  ...databaseInput,
  day_of_week: z.string().min(1).describe('UTC maintenance day of week, e.g. "sunday".'),
  time_of_day: z.string().min(1).describe('UTC maintenance time of day, e.g. "13:30" or "1:30PM".'),
  confirm: confirmField('the database add-on name'),
};
